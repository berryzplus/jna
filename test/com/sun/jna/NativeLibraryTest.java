...
public class NativeLibraryTest extends TestCase {
    ...
    public void testGCNativeLibrary() throws Exception {
        ...
        final WeakReference ref = new WeakReference(lib);
        lib = null;
        System.gc();
    ...
    public void testUseSingleLibraryInstance() {
        final TestLibrary lib = (TestLibrary)Native.loadLibrary("testlib", TestLibrary.class);
        final int count = lib.callCount();
        final TestLibrary lib2 = (TestLibrary)Native.loadLibrary("testlib", TestLibrary.class);
        final int count2 = lib2.callCount();
    ...
    public void testAliasLibraryFilename() {
        final TestLibrary lib = (TestLibrary)Native.loadLibrary("testlib", TestLibrary.class);
        final int count = lib.callCount();
        final NativeLibrary nl = NativeLibrary.getInstance("testlib");
        final TestLibrary lib2 = (TestLibrary)Native.loadLibrary(nl.getFile().getName(), TestLibrary.class);
        final int count2 = lib2.callCount();
    ...
    public void testAliasLibraryFullPath() {
        ...
        final int count = lib.callCount();
        final NativeLibrary nl = NativeLibrary.getInstance("testlib");
        final TestLibrary lib2 = (TestLibrary)Native.loadLibrary(nl.getFile().getAbsolutePath(), TestLibrary.class);
        final int count2 = lib2.callCount();
    ...
    public void testAliasSimpleLibraryName() throws Exception {
        ...
        final File file = nl.getFile();
        final WeakReference ref = new WeakReference(nl);
        nl = null;
        System.gc();
        final long start = System.currentTimeMillis();
        while (ref.get() != null) {
        ...
        final TestLibrary lib = (TestLibrary)Native.loadLibrary(file.getAbsolutePath(), TestLibrary.class);
        final int count = lib.callCount();
        final TestLibrary lib2 = (TestLibrary)Native.loadLibrary("testlib", TestLibrary.class);
        final int count2 = lib2.callCount();
    ...
    public void testLoadFrameworkLibrary() {
        if (Platform.isMac()) {
            try {
                final NativeLibrary lib = NativeLibrary.getInstance("CoreServices");
    ...
    public void testLookupGlobalVariable() {
        final NativeLibrary lib = NativeLibrary.getInstance("testlib");
        final Pointer global = lib.getGlobalVariableAddress("test_global");
    ...
    public void testMatchUnversionedToVersioned() throws Exception {
    	final File lib0 = File.createTempFile("lib", ".so.0");
    	final File dir = lib0.getParentFile();
    	String name = lib0.getName();
    	name = name.substring(3, name.indexOf(".so"));
    	lib0.deleteOnExit();
    	final File lib1 = new File(dir, "lib" + name + ".so.1.0");
        lib1.createNewFile();
    	lib1.deleteOnExit();
    	final File lib1_1 = new File(dir, "lib" + name + ".so.1.1");
        lib1_1.createNewFile();
    	lib1_1.deleteOnExit();
    	final List path = Arrays.asList(new String[] { dir.getAbsolutePath() });
    ...
    public void testAvoidFalseMatch() throws Exception {
        final File lib0 = File.createTempFile("lib", ".so.1");
    	final File dir = lib0.getParentFile();
        lib0.deleteOnExit();
    	String name = lib0.getName();
    	name = name.substring(3, name.indexOf(".so"));
        final File lib1 = new File(dir, "lib" + name + "-client.so.2");
        lib1.createNewFile();
        lib1.deleteOnExit();
    	final List path = Arrays.asList(new String[] { dir.getAbsolutePath() });
    ...
    public void testGetProcess() {
        ...
        final NativeLibrary process = NativeLibrary.getProcess();
        // Access a common C library function
        process.getFunction("printf");
    }

    private String expected(final String f) {
