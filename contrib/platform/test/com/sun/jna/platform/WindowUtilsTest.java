...
public class WindowUtilsTest extends TestCase {
    ...
    MouseInputAdapter handler = new MouseInputAdapter() {
        ...
        public void mouseDragged(final MouseEvent e) {
            if (offset != null) {
                ...
                final Point where = e.getPoint();
                where.translate(-offset.x, -offset.y);
                final Point loc = w.getLocationOnScreen();
    ...
    protected void tearDown() {
        robot = null;
        if (!GraphicsEnvironment.isHeadless()) {
            final Window[] owned = JOptionPane.getRootFrame().getOwnedWindows();
    ...
    public void xtestReveal() throws Exception {
        ...
        Container content;
        if (true) {
            final JFrame frame = new JFrame(getName(), gconfig);
    ...
    public void xtestWindowTransparency() throws Exception {
        if (GraphicsEnvironment.isHeadless())
            return;
        System.setProperty("sun.java2d.noddraw", "true");
        final GraphicsConfiguration gconfig = WindowUtils.getAlphaCompatibleGraphicsConfiguration();
        final Frame root = JOptionPane.getRootFrame();
    ...
    public void xtestWindowAlpha() throws Exception {
        ...
        final Point where = new Point(transparent.getX() + W/2,
