...
public class Secur32UtilTest extends TestCase {
    ...
    public static void main(final String[] args) {
		...
		for(final SecurityPackage sp : Secur32Util.getSecurityPackages()) {
			System.out.println(" " + sp.name + ": " + sp.comment);
		}
    }

	public void testGetUsernameEx() {
		final String usernameSamCompatible = Secur32Util.getUserNameEx(
				EXTENDED_NAME_FORMAT.NameSamCompatible);
	...
	public void testGetSecurityPackages() {
		final SecurityPackage[] sps = Secur32Util.getSecurityPackages();
		for(final SecurityPackage sp : sps) {
