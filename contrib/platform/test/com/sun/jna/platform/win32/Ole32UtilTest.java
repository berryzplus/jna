...
public class Ole32UtilTest extends TestCase {
    ...
    public void testGenerateGUID() {
    	final GUID guid1 = Ole32Util.generateGUID();
    	final GUID guid2 = Ole32Util.generateGUID();
    ...
    public void testGetGUIDFromString() {
    	final GUID lpiid = Ole32Util.getGUIDFromString("{13709620-C279-11CE-A49E-444553540000}");
    ...
    public void testGetGUIDToFromString() {
    	final GUID guid = Ole32Util.generateGUID();
