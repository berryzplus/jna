...
public class Shell32Test extends TestCase {
    ...
    public void testSHGetFolderPath() {
    	...
    	assertEquals(WinError.S_OK, Shell32.INSTANCE.SHGetFolderPath(null,
    ...
    public void testSHGetDesktopFolder() {
        final PointerByReference ppshf = new PointerByReference();
        final WinNT.HRESULT hr = Shell32.INSTANCE.SHGetDesktopFolder(ppshf);
