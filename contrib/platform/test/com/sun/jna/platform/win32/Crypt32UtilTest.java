...
public class Crypt32UtilTest extends TestCase {
    ...
    public void testCryptProtectUnprotectData() {
    	...
    	data[0] = 42;
    	data[1] = 12;
    	final byte[] protectedData = Crypt32Util.cryptProtectData(data);
    	final byte[] unprotectedData = Crypt32Util.cryptUnprotectData(protectedData);
