...
public class Ole32Test extends TestCase {
    ...
    public void testCoCreateGUID() {
    	...
    	assertEquals(WinError.S_OK, Ole32.INSTANCE.CoCreateGuid(pguid));
    ...
    public void testIIDFromString() {
    	...
    	assertEquals(WinError.S_OK, Ole32.INSTANCE.IIDFromString(
    ...
    public void testCoInitializeEx() {
        final HRESULT hr = Ole32.INSTANCE.CoInitializeEx(null, 0);
        assertTrue(W32Errors.SUCCEEDED(hr.intValue()) || hr.intValue() == WinError.RPC_E_CHANGED_MODE);
    ...
    public void testCoCreateInstance() {
        final HRESULT hrCI = Ole32.INSTANCE.CoInitializeEx(null, 0);

        final GUID guid = Ole32Util.getGUIDFromString("{13709620-C279-11CE-A49E-444553540000}"); //Shell object
        final GUID riid = Ole32Util.getGUIDFromString("{D8F015C0-C278-11CE-A49E-444553540000}"); //IShellDispatch

        final PointerByReference iUnknown = new PointerByReference();

        final HRESULT hr = Ole32.INSTANCE.CoCreateInstance(
                guid,
