...
public abstract class Kernel32Util implements WinDef {
	 ...
	 *  Formatted message.
	 */
	public static String formatMessageFromHR(final HRESULT code) {
    	...
    	final String s = buffer.getValue().getString(0, ! Boolean.getBoolean("w32.ascii"));
	...
	public static String getTempPath() {
		final DWORD nBufferLength = new DWORD(WinDef.MAX_PATH);
