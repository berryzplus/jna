...
public abstract class DropHandler implements DropTargetListener {
    ...
    private final int acceptedActions;
    private final List<DataFlavor> acceptedFlavors;
    private final DropTarget dropTarget;
    private boolean active = true;
    private final DropTargetPainter painter;
     ...
     */
    public DropHandler(final Component c, final int acceptedActions,
                       final DataFlavor[] acceptedFlavors, final DropTargetPainter painter) {
    ...
    protected int getDropAction(final DropTargetEvent e) {
        ...
        if (isSupported(flavors)) {
            final int availableActions = getDropActionsForFlavors(flavors);
     ...
     * @see #canDrop(DropTargetEvent, int, Point)
     */
    protected int getDropAction(final DropTargetEvent e, int currentAction,
                                final int sourceActions, final int acceptedActions) {
        final boolean modifiersActive = modifiersActive(currentAction);
        if ((currentAction & acceptedActions) == DragHandler.NONE
            && !modifiersActive) {
            final int action = acceptedActions & sourceActions;
    ...
    protected int acceptOrReject(final DropTargetDragEvent e) {
        final int action = getDropAction(e);
    ...
    public void dragEnter(final DropTargetDragEvent e) {
        ...
        final int action = acceptOrReject(e);
